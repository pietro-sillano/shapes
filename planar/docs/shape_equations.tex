...
In the planar geometry limit, the vesicle radius $R_{ve} \to \infty$, rendering an evaluation of $r_{pa}^{ve}$ meaningless. The natural intrinsic physical length scale is instead the characteristic length $\lambda$:
\begin{equation}
