...
\cite{agudo-canalejoCriticalParticleSizes2015} volume is also conserved.
...
\begin{itemize}
  \item Canalejo and liposki \cite{agudo-canalejoStabilizationMembraneNecks2016}
  \item \cite{spankeDynamicsSpontaneousWrapping2022} here they look at the dynamics. they approximate with a free energy depending on $z$ only, the use shooting method and thet study the dynamics (quasi dynamics).
