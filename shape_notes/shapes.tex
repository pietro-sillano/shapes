...
\begin{align*}
  E_{bo} &= (-2 \pi |W| R_{pa}^2 + 4 \pi k(1+m R_{pa})^2)(1-\cos \phi) \\
  =&(-2 \pi |W| R_{pa}^2 + 4 \pi k R_{pa}^2)(1-\cos \phi)
\end{align*}
...
\bar{\psi_3} = (3\bar{\Sigma} \bar{u_0} - 2 \bar{u_0}^3) \Omega^3 & \bar{u_0} = \bar{u_0} & \bar{u_1} = \frac{\Omega^2}{2} (3\bar{u_0} \bar{\Sigma} - 2 \bar{u_0}^3) \\[15pt]
\gamma_1 = 2 \pi \bar{\Sigma} k \Omega & \gamma_3 = \frac{4}{3} \pi k \bar{u_0} \Omega^3 (3 \bar{\Sigma} \bar{u_0} - 2 \bar{u_0}^3) & \bar{V_4} = \frac{9}{2} \bar{u_0} \Omega^4 \\[15pt]
