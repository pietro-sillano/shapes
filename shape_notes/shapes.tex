...
\begin{figure}[ht]
  \begin{center}
      \includegraphics[width=0.8\linewidth]{shape\ equation\ schematic.png}
...
$C_2$ is given by the general definition of curvature: The rate at which $\psi$ changes with respect to the arc length $s$, which gives:
$$C_2=\frac{d\psi}{ds}$$

Note:  I think that R1 defines the curvature straight into (or out of) the paper, and R2 defines the curvature in the direction of s. 
