...
\begin{equation*}
  ...
  = \frac{1}{2} u^2 x +  \gamma \frac{\cos \psi}{2 k \pi} - \frac{x \Sigma}{k} - \frac{1}{2} \frac{\sin^2 \psi}{x}
\end{equation*}



\begin{equation*}
    H = \frac{x}{2} \bigg[  \dot{\psi}^2 - \frac{\sin^2 \psi}{x^2} \bigg] - \frac{\Sigma}{k} x + \gamma \frac{\cos \psi}{2\pi k}
\end{equation*}
...
$$
$$
\psi_3 = \frac{3\gamma_1 u_0}{2 \pi k} = \frac{6 \pi \Sigma u_0}{2 \pi k} = \frac{3 \Sigma u_0}{k}
$$
...
$$
$$
\gamma_3 = \frac{4}{3} k \pi \psi_3 u_0 = 4 \pi (\Sigma u_0) = 4 \pi \Sigma u_0 ,\; \gamma_4 = 0
$$
...
$$
\gamma(s) = 2 \pi \Sigma s + \frac{2}{9} k \pi \psi_3 u_0 s^3 = 2 \pi \Sigma s + \frac{1}{9}  u_0 (6 \pi u_0 \Sigma)s^3
$$

$$
\psi(s)=u_0s + \frac{3  \Sigma u_0}{6 k }s^3
$$
...
\bar{\gamma} = \gamma R_{ve} & \bar{\Sigma} = \Sigma \frac{R_{ve}^2}{k} & \bar{A} = \frac{A}{4 \pi R_{ve}^2 } \\[15pt]
...
\gamma_1 = 2 \pi \bar{\Sigma} k \Omega & \gamma_3 = \frac{4}{3} \pi k \bar{u_0} \Omega^3 (3 \bar{\Sigma} \bar{u_0}) & \bar{V_4} = \frac{9}{2} \bar{u_0} \Omega^4 \\[15pt]
...
$$
a_{21} = \frac{df_{u}}{d\psi} = \Omega \left(\frac{u}{x} \sin \psi + \frac{1}{x^2} \cos^2 \psi + \frac{1}{x^2} \sin^2 \psi \frac{\gamma}{2 \pi k x } \cos \psi\right)
$$
...
$$
\bar{E_{un}} = 2 \pi \Omega k \int_{0}^{1} \left[ \frac{\bar{x}}{2} \left(\bar{u} + \frac{\sin \bar{\psi}}{\bar{x}}\right)^2 + \bar{\Sigma} \bar{x} \right] d\bar{s}
$$
